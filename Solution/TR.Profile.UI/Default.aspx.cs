...
namespace TR.Profile.UI
{
	public partial class DefaultPage : Page
	{
		...
		protected void CreateProfileLinkButton_Click(object sender, EventArgs e)
		{
			Domain.Profile profile;
			try
			{
				profile = UIHelper.PopulateProfile(this.Session);
			}
			catch (Exception ex)
			{
			...
			Navigator.RedirectToITICPage(profile, this.Response);
		}
