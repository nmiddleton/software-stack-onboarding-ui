					...
					<tr>
                        <td>
							<table border="0px" cellpadding="0px" cellspacing="0px" width="100%" style="border: thin solid Gray; ">
								...
								<tr>
									<td align="center">
										<table border="0px" cellpadding="0px" width="700px" style="border: thin dashed #66CCFF; margin:10px;">
											<tr>
											...
											<tr>
												<td>
													<table border="0px" cellpadding="0px" cellspacing="10px">
														...
														<tr>
															<td align="right" valign="bottom"><asp:Button ID="RemoveScanButton" runat="server" Text="Remove" Width="80px" onclick="RemoveScanButton_Click" /></td>
														</tr>
													</table>
												</td>
											</tr>
													...
													<table border="0px" cellpadding="0px" cellspacing="10px">
														<tr>
															<td align="right" valign="top">
																<table border="0px" cellpadding="0px" cellspacing="10px">
																	<tr>
																		<td align="right" valign="top">Name:&nbsp;<asp:TextBox ID="WorkflowNameTextBox" runat="server" Width="250px"/></td>
																		<td valign="top" rowspan="4"><asp:ListBox ID="WorkflowsListBox" runat="server" Width="300px" Height="150px" SelectionMode="Multiple"/></td>
																	</tr>
																	<tr>
																		<td align="right" valign="top">Data:&nbsp;<asp:TextBox ID="WorkflowDataTextBox" runat="server" Width="250px"/></td>
																	</tr>
																	<tr>
																		<td align="right" valign="middle"><asp:Button ID="AddWorkflowButton" runat="server" 
																				Text="Add->" Width="80px" onclick="AddWorkflowButton_Click" /></td>
																	</tr>
																	<tr>
																		<td align="right" valign="bottom"><asp:Button ID="RemoveWorkflowButton" 
																				runat="server" Text="Remove" Width="80px" 
																				onclick="RemoveWorkflowButton_Click" /></td>
																	</tr>
																</table>
															</td>
														</tr>
