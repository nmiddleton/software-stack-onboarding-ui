///
///                           $Id: LogicalSystemGroupLookup.cs 14380 2011-01-04 10:18:24Z neil.middleton $
...
{
	[Serializable]
    public sealed class LogicalSystemGroupLookup : ILookup
    {
        ...
        #region ctor
        public LogicalSystemGroupLookup(string pCode, string pName)
            : this()
        {
            this.Code = pCode;
            this.Name = pName;
        }
        public LogicalSystemGroupLookup()
        {
