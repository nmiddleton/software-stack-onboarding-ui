///
///                           $Id: InfrastructureLookup.cs 14380 2011-01-04 10:18:24Z neil.middleton $
///              $LastChangedDate: 2011-01-04 10:18:24 +0000 (Tue, 04 Jan 2011) $
///          $LastChangedRevision: 14380 $
///                $LastChangedBy: neil.middleton $
///                      $HeadURL: https://sami.cdt.int.thomsonreuters.com/svn/gms_gmi/trunk/infrastructure/tools/webfrontend/Solution/TR.Profile.Domain/Lookups/InfrastructureLookup.cs $
///
...
{
	[Serializable]
    public sealed class InfrastructureLookup : ILookup
    {
        ...
        #region ctor
        public InfrastructureLookup(string pCode, string pName) : this()
        {
            this.Code = pCode;
            this.Name = pName;
        }
        public InfrastructureLookup()
        {
